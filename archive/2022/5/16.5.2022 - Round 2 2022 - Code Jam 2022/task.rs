//{"name":"Task","group":"Google Coding Competitions - Round 2 2022 - Code Jam 2022","url":"https://codingcompetitions.withgoogle.com/codejam/round/00000000008778ec/0000000000b158f8#problem","interactive":false,"timeLimit":10000,"tests":[{"input":"4\n2\n-3 0\n-1 0\n3 0\n-2 -1\n-2 1\n1\n0 0\n1 1\n2 2\n3\n10 0\n-10 0\n0 0\n0 5\n-1 0\n5 0\n0 -5\n2\n3 4\n3 4\n5 7\n3 4\n5 7\n","output":"Case #1: POSSIBLE\n2 2\n1 3\nCase #2: IMPOSSIBLE\nCase #3: POSSIBLE\n3 2\n2 4\n1 3\nCase #4: POSSIBLE\n1 2\n2 3\n"}],"testType":"multiNumber","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"Task"}}}
...
fn solve(input: &mut Input, test_case: usize) {
    ...
    for i in 0..n {
        for j in 0..n {
            all_dists.push(children[i].dist2(&sweets[j]));
        }
    }
    all_dists.sort();
    ...
    for i in 0..n {
        ...
        for j in 0..n {
            ...
            if d2 <= d_bad {
                a[i][j] = all_dists.binary_search(&d2).unwrap() as i64;
    ...
    if let Some(res) = res {
        ...
        let expect_edge = res.column_per_row;
